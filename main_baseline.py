...
flags.DEFINE_string("score_func", 'ComplEx', "Defines score function: DistMult, ComplEx or TransE [DistMult]")
...
def main(_):
    ...
    vkge.baseline(embedding_size=FLAGS.embedding_size, no_batches=FLAGS.no_batches, dataset=FLAGS.dataset,
