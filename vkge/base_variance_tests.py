        ...
        with tf.Session() as session:
            ...
            # logger.warn('Sample Mean \t {} \t Sample Var \t {}'.format(samp1_mu[:20],samp1_sig[:20]))
                    ...
                    for _i, (s, p, o) in enumerate(eval_triples):
                        ...
                        if self.alt_test in ['test1','test2']: #CORRECTION of scores for confidence TEST1
                        ...
                        elif self.alt_test in ['test1_bline','test2_bline']: #creates random confidence levels between 0 and 1 for baseline test1
                        ...
                        if self.alt_test in ['test1','test1_bline','test2_bline']: #multiply by binary threshold on variance
                        ...
                        if self.alt_test in ['none','test2']:
                            ranks_subj += [1 + np.sum(confidence_subj > confidence_subj[s_idx])]
                            ranks_obj += [1 + np.sum(confidence_obj > confidence_obj[o_idx])]
